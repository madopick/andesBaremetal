...
#define MISC_CTL_offIBPT	9	/* ULM External Port Access I-bank Protection */
#define MISC_CTL_offHW_PREFETCH	11	/* Enable Hardware Prefetch */
#define MISC_CTL_offVRMPU	12	/* Disable VRMPU */
/* bit 13:31 reserved */
...
#define MISC_CTL_mskIBPT	( 0x3 << MISC_CTL_offIBPT )
#define MISC_CTL_mskHW_PREFETCH	( 0x1 << MISC_CTL_offHW_PREFETCH )
#define MISC_CTL_mskVRMPU	( 0x1 << MISC_CTL_offVRMPU )
